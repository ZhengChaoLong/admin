<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\www\tpAdmin\public/../application/admin\view\admin_node\edit.html";i:1480493942;s:66:"E:\www\tpAdmin\public/../application/admin\view\template\base.html";i:1480493942;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <div class="select-box">
                    <select name="group_id" class="select">
                        ...
                        <?php if(is_array($group_list) || $group_list instanceof \think\Collection): if( count($group_list)==0 ) : echo "" ;else: foreach($group_list as $key=>$group): ?>
