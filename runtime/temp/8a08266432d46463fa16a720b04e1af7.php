<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"E:\www\tpAdmin\public/../application/admin\view\index\index.html";i:1480669855;s:70:"E:\www\tpAdmin\public/../application/admin\view\template\nav_left.html";i:1480669929;s:70:"E:\www\tpAdmin\public/../application/admin\view\template\nav_menu.html";i:1480670972;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<?php echo \think\Url::build('/admin'); ?>"><?php echo \think\Config::get('site.name'); ?></a>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <?php if(is_array($groups) || $groups instanceof \think\Collection): $i = 0; $__LIST__ = $groups;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$group): $mod = ($i % 2 );++$i;?>
    <dl>
        <dt>
            <i class="Hui-iconfont"><?php echo (htmlspecialchars_decode($group['icon']) !== ''?htmlspecialchars_decode($group['icon']):'&#xe616;'); ?></i>
            <?php echo $group['name']; ?><i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
        </dt>
        <dd>
            <ul>
                <?php if(is_array($menu[$group['id']]) || $menu[$group['id']] instanceof \think\Collection): $i = 0; $__LIST__ = $menu[$group['id']];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
