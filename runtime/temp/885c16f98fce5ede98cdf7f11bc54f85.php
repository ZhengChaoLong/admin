<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"E:\www\tpAdmin\public/../application/admin\view\web_log\index.html";i:1480493942;s:66:"E:\www\tpAdmin\public/../application/admin\view\template\base.html";i:1480493942;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-hover table-bg mt-20">
        ...
        <tr class="text-c">
            ...
            <td><?php echo !empty($vo['is_ajax'])?'<span class="c-red">是</span>':'否'; ?></td>
            ...
            <td><?php echo date('Y-m-d H:i:s',$vo['otime']); ?></td>
            <td>
